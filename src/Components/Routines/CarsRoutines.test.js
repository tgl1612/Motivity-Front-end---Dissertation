...
import CarsRoutines from './CarsRoutines';
...
describe('Routines Component Tests', () =>{
    ...
    it('should contain <h5 style={{color: "red"}}><strong>Level: </strong>Advanced</h5> if level: 3', ()=>{
        wrapper.setProps({id: 1, title: 'test title', level: 3})
        expect(wrapper.contains(<h5 style={{color: 'red'}}><strong>Level: </strong>Advanced</h5>)).toEqual(true);
    }); 
