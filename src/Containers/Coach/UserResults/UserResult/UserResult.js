...
import classes from './UserResult.css';
import axios from '../../../../axios-instance';
import Spinner from '../../../../Components/UI/Spinner/Spinner';
import {Redirect, Link} from 'react-router-dom';
import Button from '../../../../Components/UI/Button/Button';

//UserResult page to let an admin view an individual user's assessment result in detail
...
class UserResult extends Component{
    ...
    componentDidMount(){
        ...
        Promise.all([axios.get('/routines/countroutine/' + this.state.userId + '/' +  this.state.assessmentId, {
            headers: {
    ...
    render(){
        ...
        if(this.state.overallScore ===1){
            overallScore =  <strong style={{color: 'green'}}>Novice</strong>
        }else if(this.state.overallScore ===2){
            overallScore = <strong style={{color: 'orange'}}>Intermediate</strong>
        }else if(this.state.overallScore ===3){
            overallScore = <strong style={{color: 'red'}}>Advanced</strong>
        }else{
            overallScore =  <strong style={{color: 'green'}}>Novice</strong>
        }
      ...
      return(
                ...
                <div className = {classes.Container}>  
                    ...
                    <div className = {classes.Results}>
                        ...
                        <h5><strong>Overall level: </strong>{overallScore}</h5>
                    ...
                    <Link to={'/results/' + this.state.userId}><Button btnType = 'Blue'>Back</Button></Link>    
                </div>
            );
        }
